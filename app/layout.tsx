...
export const metadata: Metadata = {
  title: "Ahmad Niknam | IT Support, Systems Support, and Technical Projects",
  description:
    "Portfolio of Ahmad Niknam, an IT Support Specialist focused on systems and network support, Microsoft 365, Windows Server, Azure, PowerShell automation, monitoring, documentation, and practical web systems projects.",

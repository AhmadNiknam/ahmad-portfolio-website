      ...
      <div className="reveal grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-slate-950 p-7 text-white shadow-2xl shadow-slate-200 sm:p-8">
          ...
          <p className="mt-4 leading-7 text-slate-200">
            Use the resume download, LinkedIn profile, GitHub portfolio, or email placeholder to
            start a conversation about systems support, infrastructure administration, Azure
            operations, or IT automation work.
          </p>
          ...
          <p className="mt-4 text-sm font-medium text-slate-300">
            Email placeholder ready to update: {profileLinks.emailLabel}
          </p>
          </div>
        </div>
      </div>
